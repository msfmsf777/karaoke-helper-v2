...
class AudioPlayer:
    ...
    def _load_worker(self, instrumental_path, vocal_path, pitch_semitones, sample_rate, normalize, target_lufs):
        try:
            ...
            self.window.write_event_value("-LOAD_PROGRESS_EVENT-", (0, "load_status_reading_audio"))
            ...
            self.window.write_event_value("-LOAD_PROGRESS_EVENT-", (15, "load_status_reading_audio"))

            # Load vocal (with fallback)
            vocal_audio = _load_with_ffmpeg(vocal_path, self.sample_rate)
            self.window.write_event_value("-LOAD_PROGRESS_EVENT-", (30, "load_status_converting_audio"))
            ...
            if normalize:
                ...
                self.window.write_event_value("-LOAD_PROGRESS_EVENT-", (45, "load_status_normalizing"))
            ...
            if pitch_semitones != 0:
                self.window.write_event_value("-LOAD_PROGRESS_EVENT-", (65, "load_status_pitch_shift"))
                ...
                self.window.write_event_value("-LOAD_PROGRESS_EVENT-", (90, "load_status_mixing"))
